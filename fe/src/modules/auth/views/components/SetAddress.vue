   ...
   <v-card class="pl-4 pr-4">
    ...
    <v-container>
     <v-row class="ml-4 mr-4 mt-1 mb-1 border-orange position-relative" style="height: 400px">
      <gmap-map ref="mapRef" @click="addLocationMarker" class="rounded-xl" :zoom="zoom" :options="{ mapTypeControl: false, streetViewControl: false }" :center="center" style="width: 100%; height: 100%">
