  ...
  <v-container class="mt-15">
   ...
   <v-row justify="center" align="center">
    <v-col cols="12" sm="12" md="12" lg="12">
     ...
     <v-data-iterator class="row no-gutters row--dense" :items="latest_products" :items-per-page.sync="itemsPerPage" :page.sync="page" :search="search" :sort-by="sortBy" :sort-desc="sortDesc" hide-default-footer>
   ...
   <v-container class="pb-10 pt-15">
    <v-row justify="center" align="center" class="h-100">
     ...
     <v-col cols="12" sm="11" md="7" lg="6">
      ...
      <h3 class="font-weight-light darken-3 mt-3"> It's all at your fingertips – the fresh fruits, vegetables and meat. Find the right food in the market and we will deliver it to your doorstep. Go ahead, download us. </h3>
      <div class="mt-4">
       <v-btn depressed class="mt-3 me-2" text large disabled>
...
<script>
 ...
 export default {
  ...
  computed: {
   ...
   //Category Sorting
   sortedProducts() {
    return this.sortAllDesc ? this.products.data.slice().sort((a, b) => a.product_info.price - b.product_info.price) : this.products.data.slice().sort((a, b) => b.product_info.price - a.product_info.price);
   },
  },
  watch: {
   selectedCategory() {
