...
use App\Http\Controllers\AdminArchivedPartnerController;
...
Route::middleware('api')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::apiResource('archived-partners', AdminArchivedPartnerController::class);
        ...
        Route::get('all-orders', [RiderController::class, 'allOrders']);
        Route::get('order-info/{id}', [RiderController::class, 'orderInfo']);
        Route::put('accept-order/{id}', [RiderController::class, 'acceptOrder']);
        Route::put('complete-order/{id}', [RiderController::class, 'completeOrder']);
    });
